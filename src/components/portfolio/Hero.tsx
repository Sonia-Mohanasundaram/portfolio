      ...
      <div className="mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-14 md:grid-cols-2">
        ...
        <div className="order-2 md:order-1">
          ...
          <motion.h1 initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }}
            className="font-display text-6xl md:text-8xl font-black leading-[0.9] tracking-tight text-gradient animate-gradient"
        ...
        <div className="order-1 md:order-2 flex justify-center">
          <div ref={cardRef} className="relative h-[360px] w-[360px] md:h-[440px] md:w-[440px]"
